...
public class TestWaveDrawable extends Drawable implements Animatable, ValueAnimator.AnimatorUpdateListener {
    ...
    public TestWaveDrawable(Drawable drawable) {
        init(drawable);
    }

    public TestWaveDrawable(Context context, int imgRes) {
        Drawable drawable;
