...
public class TouTiaoNewsImageProvider extends BaseItemProvider<MultiNewsArticleBeanData>{
    ...
    @Override
    public int viewType() {
        return TouTiaoMultiNewRvAdapter.IMAGE_ITEM_PROVIDER;
    }

    @Override
    public int getLayout() {
        return R.layout.toutiao_fragment_news_image_right_content;
    }
    ...
    public void convert(final BaseHolder holder, MultiNewsArticleBeanData data, final int position) {
        ...
        ImageView ivThumbnail = (ImageView) holder.getView(R.id.toutiao_iv_thumbnail);
