...
public class WendaArticleBeanData implements MultiItemEntity {
    /**
     * cell_type : 36
    ...
    public static final int WENDA_THREE_IMG_TYPE = 0x0001;

    public static final int WENDA_ONE_IMG_TYPE = 0x0002;

    public static final int WENDA_TEXT_TYPE = 0x0003;

    @Override
    public int getItemType() {
        if (null != getExtraBean().getWenda_image() &&
                null != getExtraBean().getWenda_image().getThree_image_list() &&
                getExtraBean().getWenda_image().getThree_image_list().size() > 0) {
            return WENDA_THREE_IMG_TYPE;
        }
        if (null != getExtraBean().getWenda_image() &&
                null != getExtraBean().getWenda_image().getLarge_image_list() &&
                getExtraBean().getWenda_image().getLarge_image_list().size() > 0) {
            return WENDA_ONE_IMG_TYPE;
        }
        return WENDA_TEXT_TYPE;
